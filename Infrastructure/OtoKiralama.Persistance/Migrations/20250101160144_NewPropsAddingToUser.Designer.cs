...
namespace OtoKiralama.Persistance.Migrations
{
    ...
    [Migration("20250101160144_NewPropsAddingToUser")]
    partial class NewPropsAddingToUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OtoKiralama.Domain.Entities.Company", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2025, 1, 1, 20, 1, 43, 319, DateTimeKind.Local).AddTicks(1225));
            ...
            modelBuilder.Entity("OtoKiralama.Persistance.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 1, 20, 1, 43, 310, DateTimeKind.Local).AddTicks(5004));
