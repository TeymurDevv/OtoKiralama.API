...
namespace OtoKiralama.Persistance.Migrations
{
    ...
    [Migration("20250222212046_updateintdecimaltodouble")]
    partial class updateintdecimaltodouble
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OtoKiralama.Domain.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 2, 23, 1, 20, 45, 935, DateTimeKind.Local).AddTicks(3384));
            ...
            modelBuilder.Entity("OtoKiralama.Domain.Entities.Company", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 2, 23, 1, 20, 45, 945, DateTimeKind.Local).AddTicks(1913));
            ...
            modelBuilder.Entity("OtoKiralama.Domain.Entities.FilterRange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OtoKiralama.Domain.Entities.CorporateInvoice", b =>
                {
                    b.HasBaseType("OtoKiralama.Domain.Entities.Invoice");
            ...
            modelBuilder.Entity("OtoKiralama.Domain.Entities.IndividualCompanyInvoice", b =>
                {
                    b.HasBaseType("OtoKiralama.Domain.Entities.Invoice");

                    b.ToTable("IndividualCompanyInvoices", (string)null);
                });

            modelBuilder.Entity("OtoKiralama.Domain.Entities.IndividualInvoice", b =>
                {
                    b.HasBaseType("OtoKiralama.Domain.Entities.Invoice");

                    b.ToTable("IndividualInvoices", (string)null);
                });
            ...
            modelBuilder.Entity("OtoKiralama.Domain.Entities.Invoice", b =>
                {
                    b.HasOne("OtoKiralama.Domain.Entities.AppUser", "AppUser")
                        .WithOne("Invoice")
                        .HasForeignKey("OtoKiralama.Domain.Entities.Invoice", "AppUserId");

                    b.HasOne("OtoKiralama.Domain.Entities.Country", "Country")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("OtoKiralama.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.HasOne("OtoKiralama.Domain.Entities.Location", "DropOfLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("OtoKiralama.Domain.Entities.CorporateInvoice", b =>
                {
                    b.HasOne("OtoKiralama.Domain.Entities.Invoice", null)
                        .WithOne()
                        .HasForeignKey("OtoKiralama.Domain.Entities.CorporateInvoice", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("OtoKiralama.Domain.Entities.IndividualCompanyInvoice", b =>
                {
                    b.HasOne("OtoKiralama.Domain.Entities.Invoice", null)
                        .WithOne()
                        .HasForeignKey("OtoKiralama.Domain.Entities.IndividualCompanyInvoice", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("OtoKiralama.Domain.Entities.IndividualInvoice", b =>
                {
                    b.HasOne("OtoKiralama.Domain.Entities.Invoice", null)
                        .WithOne()
                        .HasForeignKey("OtoKiralama.Domain.Entities.IndividualInvoice", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
