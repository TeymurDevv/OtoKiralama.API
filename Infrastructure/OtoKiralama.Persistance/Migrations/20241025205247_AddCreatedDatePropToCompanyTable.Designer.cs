...
namespace OtoKiralama.Persistance.Migrations
{
    ...
    [Migration("20241025205247_AddCreatedDatePropToCompanyTable")]
    partial class AddCreatedDatePropToCompanyTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OtoKiralama.Domain.Entities.Company", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 10, 25, 13, 52, 47, 349, DateTimeKind.Local).AddTicks(1454));
            ...
            modelBuilder.Entity("OtoKiralama.Persistance.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 25, 13, 52, 47, 348, DateTimeKind.Local).AddTicks(8421));
